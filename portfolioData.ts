...
export const portfolioData = {
  ...
  skills: [
    { label: "Python & Automation", color: "#ff2c8a" },
    { label: "AI Agents & Workflows", color: "#ff7a45" },
    { label: "LLM / API Integration", color: "#7d86ff" },
    { label: "Full-Stack Engineering", color: "#d75dff" },
    { label: "Video Automation", color: "#f2d37b" },
  ],
  experience: [
    {
